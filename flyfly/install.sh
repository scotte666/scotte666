...
install_pip_module() {
    ...
    download "https://dl2.cdnfly.cn/cdnfly/pymodule-master-20211219.tar.gz" "https://dl2.cdnfly.cn/cdnfly/pymodule-master-20211219.tar.gz" "pymodule-master-20211219.tar.gz"
...
if [[ ! -f "/etc/elasticsearch/elasticsearch.yml" ]]; then
    if check_sys sysRelease ubuntu;then
        ...
        cd /tmp
        download "https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.6.1-x86_64.rpm" "https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.6.1-x86_64.rpm" "elasticsearch-7.6.1-x86_64.rpm"
